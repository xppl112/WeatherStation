...
const int DATA_COLLECTION_CAPACITY = 30;

const int SENSORS_SCAN_INTERVAL_SECONDS = 30;//30
const uint8_t PM_SENSOR_MEASUREMENT_DURATION_CYCLES = 2;//2
const uint8_t PM_SENSOR_CALMDOWN_DURATION_CYCLES = 4;//4
