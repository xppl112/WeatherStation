...
public:
        ...
        if (currentAnimation == Animation::SCROLL_LEFT) {
            if (tasker.check()) {
                ...
                sendToDisplay<DataCommand_e::AUTOMATIC_ADDRESS_ADDING, AddressCommand_e::C0H>(
                        ...
                        static_cast<size_t>(_min(totalDigits_, s.length())));
            }
            return;
        }
        tasker.reset(delay, millis());
    ...
    void refresh()
    {
        sendToDisplay<DataCommand_e::AUTOMATIC_ADDRESS_ADDING, AddressCommand_e::C0H>(
                ...
                static_cast<size_t>(_min(totalDigits_, buffer_.length())));
    }
...
#undef CASER
    ...
    const uint8_t ascii[128] =
    {
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x22, 0x00, 0x6D, 0x52, 0x00, 0x20,
        ...
        0x5B, 0x39, 0x64, 0x00, 0x01, 0x08, 0x20, 0x77, 0x7C, 0x63,
